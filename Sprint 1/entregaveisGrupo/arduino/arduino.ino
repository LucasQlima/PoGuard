...
void loop() {
  ...
  int temperatura4 = random(-24, -10);
  int temperatura5 = random(-24, -10);
  int temperatura6 = random(-24, -10);
  int temperatura7 = random(-24, -10);
  int temperatura8 = random(-24, -10);
  int temperatura9 = random(-24, -10);
  int temperatura10 = random(-24, -10);
  int temperatura11 = random(-24, -10);
  int temperatura12 = random(-24, -10);
  int temperatura13 = random(-24, -10);
  int temperatura14 = random(-24, -10);
  int temperatura15 = random(-24, -10);
  int temperatura16 = random(-24, -10);
  int temperatura17 = random(-24, -10);
  int temperatura18 = random(-24, -10);
  int temperatura19 = random(-24, -10);
  int temperatura20 = random(-24, -10);
  int temperatura21 = random(-24, -10);
